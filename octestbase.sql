...
--
-- Host: localhost    Database: octestbase
-- ------------------------------------------------------
...
INSERT INTO `oc_api` VALUES (1,'Default','',1,'2023-03-05 15:17:20','2023-03-05 15:17:20');
...
INSERT INTO `oc_currency` VALUES (1,'Рубль','RUB','',' р.','2',1.00000000,1,'2023-03-06 21:29:19'),(2,'US Dollar','USD','$','','2',0.01324981,1,'2023-03-06 21:29:19'),(3,'Euro','EUR','','€','2',0.01246334,1,'2023-03-06 21:29:19');
...
INSERT INTO `oc_customer_login` VALUES (1,'admin','157.245.6.94',2,'2023-03-06 16:38:03','2023-03-06 16:38:08');
...
INSERT INTO `oc_modification_backup` VALUES (1,1,'likedev_wishlist_without_login','<modification>\n    <name>likeDev - wishlist without login</name>\n    <code>likedev_wishlist_without_login</code>\n    <version>1.2.3</version>\n    <author>Seriusis</author>\n    <link>https://likeDev.pro</link>\n\n    <file path=\"catalog/controller/account/wishlist.php\">\n\n        <operation>\n            <search><![CDATA[\'remove\'     => $this->url->link(\'account/wishlist\', \'remove=\' . $product_info[\'product_id\'])]]></search>\n            <add position=\"replace\"><![CDATA[\'remove\'     => $this->customer->isLogged() ? $this->url->link(\'account/wishlist\', \'remove=\' . $product_info[\'product_id\']) : $this->url->link(\'account/wishlist\', \'remove_cookie_wishlist=\' . $product_info[\'product_id\'])]]></add>\n        </operation>\n\n\n        <operation>\n            <search><![CDATA[\n      if (!$this->customer->isLogged()) {]]></search>\n            <add position=\"replace\" offset=\"4\"><![CDATA[]]></add>\n        </operation>\n        <operation>\n            <search><![CDATA[\n                if (isset($this->request->get[\'remove\'])) {]]></search>\n            <add position=\"before\"><![CDATA[\n\n               //remove product from wishlist by guest\n            if (isset($this->request->get[\'remove_cookie_wishlist\'])) {\n\n		    $wishlist = isset($_COOKIE[\'cookieWishlist\']) ? json_decode($_COOKIE[\'cookieWishlist\'],1) : [];\n		    $wishlist = array_unique($wishlist);\n		    foreach ($wishlist as $k => $value){\n		        if($value == $this->request->get[\'remove_cookie_wishlist\']){\n		            unset($wishlist[$k]);\n                }\n            }\n                setcookie(\'cookieWishlist\', json_encode($wishlist), time()+3600*24*365,\'/\');\n\n                $this->response->redirect($this->url->link(\'account/wishlist\'));\n            }\n            /*end remove product from wishlist by guest*/\n\n\n\n            ]]></add>\n        </operation>\n        <operation>\n            <search><![CDATA[$results = $this->model_account_wishlist->getWishlist();]]></search>\n            <add position=\"replace\"><![CDATA[\n            if ($this->customer->isLogged()) {\n                $results = $this->model_account_wishlist->getWishlist();\n                }else{\n                 $wishlist = isset($_COOKIE[\'cookieWishlist\']) ? json_decode($_COOKIE[\'cookieWishlist\'],1) : [];\n                 $wishlist = array_unique($wishlist);\n                    $results = [];\n                    foreach ($wishlist as $value){\n                        $results[][\'product_id\'] = $value;\n                    }\n            }\n            ]]></add>\n        </operation>\n        <operation>\n            <search><![CDATA[$this->session->data[\'wishlist\'][] = $this->request->post[\'product_id\'];]]></search>\n            <add position=\"after\"><![CDATA[\n                 /*add product in wishlist by guest*/\n                $wishlist = isset($_COOKIE[\'cookieWishlist\']) ? json_decode($_COOKIE[\'cookieWishlist\'],1) : [];\n                $wishlist = array_unique($wishlist);\n                $wishlist_total = count($wishlist);\n                  if(!in_array($this->request->post[\'product_id\'], $wishlist)){\n                    $this->load->model(\'catalog/product\');\n                    $product_info = $this->model_catalog_product->getProduct($this->request->post[\'product_id\']);\n                    if($product_info){\n                     $wishlist[] = $this->request->post[\'product_id\'];\n                        $wishlist_total += 1;\n                     }\n                }\n\n                 setcookie(\'cookieWishlist\', json_encode($wishlist), time()+3600*24*365, \'/\');\n\n                $wishlist = isset($_COOKIE[\'cookieWishlist\']) ? json_decode($_COOKIE[\'cookieWishlist\'],1) : [];\n                $wishlist = array_unique($wishlist);\n                /*end add product in wishlist by guest*/\n            ]]></add>\n        </operation>\n        <operation>\n            <search><![CDATA[$json[\'total\'] = sprintf($this->language->get(\'text_wishlist\'), (isset($this->session->data[\'wishlist\']) ? count($this->session->data[\'wishlist\']) : 0));]]></search>\n            <add position=\"replace\"><![CDATA[\n            $json[\'total\'] = sprintf($this->language->get(\'text_wishlist\'), $wishlist_total);\n            ]]></add>\n        </operation>\n        <operation>\n            <search><![CDATA[$json[\'success\'] = sprintf($this->language->get(\'text_login\'), $this->url->link(\'account/login\', \'\', true), $this->url->link(\'account/register\', \'\', true), $this->url->link(\'product/product\', \'product_id=\' . (int)$this->request->post[\'product_id\']), $product_info[\'name\'], $this->url->link(\'account/wishlist\'));]]></search>\n            <add position=\"replace\"><![CDATA[$json[\'success\'] = sprintf($this->language->get(\'text_success\'), $this->url->link(\'product/product\', \'product_id=\' . (int)$this->request->post[\'product_id\']), $product_info[\'name\'], $this->url->link(\'account/wishlist\'));]]></add>\n        </operation>\n        <operation><!--oc2.1-->\n            <search><![CDATA[$json[\'success\'] = sprintf($this->language->get(\'text_login\'), $this->url->link(\'account/login\', \'\', \'SSL\'), $this->url->link(\'account/register\', \'\', \'SSL\'), $this->url->link(\'product/product\', \'product_id=\' . (int)$this->request->post[\'product_id\']), $product_info[\'name\'], $this->url->link(\'account/wishlist\'));]]></search>\n            <add position=\"replace\"><![CDATA[$json[\'success\'] = sprintf($this->language->get(\'text_success\'), $this->url->link(\'product/product\', \'product_id=\' . (int)$this->request->post[\'product_id\']), $product_info[\'name\'], $this->url->link(\'account/wishlist\'));]]></add>\n        </operation>\n    </file>\n    <file path=\"catalog/controller/common/header.php\">\n        <operation>\n        <search><![CDATA[$data[\'text_wishlist\'] = sprintf($this->language->get(\'text_wishlist\'), (isset($this->session->data[\'wishlist\']) ? count($this->session->data[\'wishlist\']) : 0));]]></search>\n        <add position=\"replace\"><![CDATA[\n      $wishlist = isset($_COOKIE[\'cookieWishlist\']) ? json_decode($_COOKIE[\'cookieWishlist\'],1) : [];\n      $wishlist = array_unique($wishlist);\n        $data[\'text_wishlist\'] = sprintf($this->language->get(\'text_wishlist\'), count($wishlist));\n        ]]></add>\n        </operation>\n    </file>\n    \n    <!--fix wishlist saving after login-->\n    <file path=\"catalog/controller/account/login.php\">\n          <operation>\n            <search index=\"0\"><![CDATA[$this->load->model(\'account/customer\');]]></search>\n            <add position=\"after\"><![CDATA[\n             $wishlist = isset($_COOKIE[\'cookieWishlist\']) ? json_decode($_COOKIE[\'cookieWishlist\'],1) : [];\n            $wishlist = array_unique($wishlist);\n                  if ($wishlist) {\n                    $this->load->model(\'account/wishlist\');\n                    $this->load->model(\'catalog/product\');\n\n                    foreach ($wishlist as $id) {\n                        $product_info = $this->model_catalog_product->getProduct($id);\n                        if ($product_info) {\n                            $this->model_account_wishlist->addWishlist($id);\n                        }\n                    }\n\n                    setcookie(\'cookieWishlist\', \'\', time()-3600*24*365,\'/\');\n                }\n            ]]></add>\n        </operation>\n    </file>\n      <file path=\"catalog/controller/account/register.php\">\n          <operation>\n            <search index=\"0\"><![CDATA[if ($this->customer->isLogged()) {]]></search>\n            <add position=\"after\"><![CDATA[\n            $wishlist = isset($_COOKIE[\'cookieWishlist\']) ? json_decode($_COOKIE[\'cookieWishlist\'],1) : [];\n            $wishlist = array_unique($wishlist);\n                if ($wishlist) {\n                    $this->load->model(\'account/wishlist\');\n                    $this->load->model(\'catalog/product\');\n    \n                    foreach ($wishlist as $id) {\n                        $product_info = $this->model_catalog_product->getProduct($id);\n                        if ($product_info) {\n                            $this->model_account_wishlist->addWishlist($id);\n                        }\n                    }\n\n                    setcookie(\'cookieWishlist\', \'\', time()-3600*24*365,\'/\');\n                }\n            \n            ]]></add>\n        </operation>\n    </file>\n    \n</modification>','2023-03-06 17:31:38');
...
INSERT INTO `oc_product_attribute` VALUES (43,2,1,'1'),(47,2,1,'4'),(43,4,1,'8гб'),(47,4,1,'16ГБ'),(43,2,2,'1'),(47,2,2,'4'),(43,4,2,'8gb'),(42,3,1,'100мгц'),(47,4,2,'16GB'),(42,3,2,'100mhz');
...
INSERT INTO `oc_product_discount` VALUES (455,42,1,30,1,66.0000,'2023-03-06','2023-03-13'),(454,42,1,20,1,77.0000,'0000-00-00','0000-00-00'),(453,42,1,10,1,88.0000,'0000-00-00','0000-00-00');
...
INSERT INTO `oc_product_reward` VALUES (550,42,1,100),(519,47,1,300),(379,28,1,400),(329,43,1,600),(339,29,1,0),(343,48,1,0),(335,40,1,0),(539,30,1,200),(331,44,1,700),(333,45,1,800),(337,31,1,0),(425,35,1,0),(345,33,1,0),(347,46,1,0),(545,41,1,0),(351,36,1,0),(353,34,1,0),(355,32,1,0),(521,49,1,1000);
...
INSERT INTO `oc_product_special` VALUES (443,42,1,1,80.0000,'2023-03-05','2023-03-13'),(439,30,1,2,90.0000,'0000-00-00','0000-00-00'),(438,30,1,1,80.0000,'0000-00-00','0000-00-00');
...
INSERT INTO `oc_setting` VALUES (275,0,'config','config_compression','0',0),(276,0,'config','config_mail_regexp','/^[^@]+@.*.[a-z]{2,15}$/i',0),(277,0,'config','config_editor_default','0',0),(4,0,'voucher','voucher_sort_order','8',0),(5,0,'voucher','voucher_status','1',0),(274,0,'config','config_robots','abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg',0),(273,0,'config','config_seo_pro_utm','block\r\nfrommarket\r\ngclid\r\nfbclid\r\nkeyword\r\nlist_type\r\nopenstat\r\nopenstat_service\r\nopenstat_campaign\r\nopenstat_ad\r\nopenstat_source\r\nposition\r\nsource\r\ntracking\r\ntype\r\nyclid\r\nymclid\r\nuri\r\nurltype\r\nutm_source\r\nutm_medium\r\nutm_campaign\r\nutm_term\r\nutm_content',0),(272,0,'config','config_add_prevnext','0',0),(271,0,'config','config_canonical_self','0',0),(270,0,'config','config_canonical_method','0',0),(269,0,'config','config_flush_cache_seopro','0',0),(268,0,'config','config_seo_url_postfix','',0),(267,0,'config','config_seo_url_include_path','0',0),(266,0,'config','config_seo_url_type','seo_url',0),(265,0,'config','config_seo_url','0',0),(264,0,'config','config_maintenance','0',0),(263,0,'config','config_alert_email','',0),(262,0,'config','config_mail_alert','[\"order\"]',1),(261,0,'config','config_mail_smtp_timeout','5',0),(260,0,'config','config_mail_smtp_port','25',0),(259,0,'config','config_mail_smtp_password','',0),(258,0,'config','config_mail_smtp_username','',0),(257,0,'config','config_mail_smtp_hostname','',0),(256,0,'config','config_mail_parameter','',0),(255,0,'config','config_mail_protocol','mail',0),(254,0,'config','config_ftp_status','1',0),(253,0,'config','config_ftp_root','',0),(252,0,'config','config_ftp_password','wW1cB3aG2j',0),(251,0,'config','config_ftp_username','octest',0),(250,0,'config','config_ftp_port','21',0),(249,0,'config','config_ftp_hostname','octest.web-space.su',0),(248,0,'config','config_icon','catalog/cart.png',0),(247,0,'config','config_logo','catalog/logo.png',0),(246,0,'config','config_captcha_page','[\"review\",\"return\",\"contact\"]',1),(245,0,'config','config_captcha','',0),(244,0,'config','config_return_status_id','2',0),(243,0,'config','config_return_id','0',0),(242,0,'config','config_affiliate_id','4',0),(241,0,'config','config_affiliate_commission','5',0),(240,0,'config','config_affiliate_auto','0',0),(239,0,'config','config_affiliate_approval','0',0),(238,0,'config','config_stock_checkout','0',0),(237,0,'config','config_stock_warning','0',0),(236,0,'config','config_stock_display','0',0),(235,0,'config','config_api_id','1',0),(234,0,'config','config_fraud_status_id','2',0),(231,0,'config','config_order_status_id','1',0),(232,0,'config','config_processing_status','[\"2\",\"3\",\"1\",\"12\",\"5\"]',1),(233,0,'config','config_complete_status','[\"3\",\"5\"]',1),(226,0,'config','config_account_id','3',0),(227,0,'config','config_invoice_prefix','INV-2013-00',0),(228,0,'config','config_cart_weight','1',0),(229,0,'config','config_checkout_guest','1',0),(230,0,'config','config_checkout_id','5',0),(216,0,'config','config_tax','1',0),(217,0,'config','config_tax_default','shipping',0),(218,0,'config','config_tax_customer','shipping',0),(219,0,'config','config_customer_online','0',0),(220,0,'config','config_customer_activity','0',0),(221,0,'config','config_customer_search','0',0),(222,0,'config','config_customer_group_id','1',0),(223,0,'config','config_customer_group_display','[\"1\"]',1),(224,0,'config','config_customer_price','0',0),(225,0,'config','config_login_attempts','5',0),(215,0,'config','config_voucher_max','1000',0),(214,0,'config','config_voucher_min','1',0),(195,0,'config','config_country_id','176',0),(194,0,'config','config_image','',0),(193,0,'config','config_fax','',0),(192,0,'config','config_telephone','123456789',0),(191,0,'config','config_email','sample@yandex.ru',0),(190,0,'config','config_geocode','54.718681,20.499113',0),(189,0,'config','config_layout_id','4',0),(188,0,'config','config_theme','theme_default',0),(98,0,'currency_cbr','currency_cbr_status','1',0),(99,0,'free_checkout','free_checkout_status','1',0),(100,0,'free_checkout','free_checkout_order_status_id','1',0),(101,0,'shipping','shipping_sort_order','3',0),(102,0,'sub_total','sub_total_sort_order','1',0),(103,0,'sub_total','sub_total_status','1',0),(104,0,'tax','tax_status','1',0),(105,0,'total','total_sort_order','9',0),(106,0,'total','total_status','1',0),(107,0,'tax','tax_sort_order','5',0),(108,0,'free_checkout','free_checkout_sort_order','1',0),(109,0,'cod','cod_sort_order','5',0),(110,0,'cod','cod_total','0.01',0),(111,0,'cod','cod_order_status_id','1',0),(112,0,'cod','cod_geo_zone_id','0',0),(113,0,'cod','cod_status','1',0),(114,0,'shipping','shipping_status','1',0),(115,0,'shipping','shipping_estimator','1',0),(116,0,'coupon','coupon_sort_order','4',0),(117,0,'coupon','coupon_status','1',0),(118,0,'flat','flat_sort_order','1',0),(119,0,'flat','flat_status','1',0),(120,0,'flat','flat_geo_zone_id','0',0),(121,0,'flat','flat_tax_class_id','9',0),(122,0,'flat','flat_cost','5.00',0),(123,0,'credit','credit_sort_order','7',0),(124,0,'credit','credit_status','1',0),(125,0,'reward','reward_sort_order','2',0),(126,0,'reward','reward_status','1',0),(127,0,'category','category_status','1',0),(128,0,'account','account_status','1',0),(129,0,'affiliate','affiliate_status','1',0),(130,0,'google_sitemap','google_sitemap_status','0',0),(131,0,'google_sitemap','google_sitemap_disable_products','1',0),(132,0,'theme_default','theme_default_product_limit','15',0),(133,0,'theme_default','theme_default_product_description_length','100',0),(134,0,'theme_default','theme_default_image_thumb_width','228',0),(135,0,'theme_default','theme_default_image_thumb_height','228',0),(136,0,'theme_default','theme_default_image_popup_width','500',0),(137,0,'theme_default','theme_default_image_popup_height','500',0),(138,0,'theme_default','theme_default_image_category_width','80',0),(139,0,'theme_default','theme_default_image_category_height','80',0),(140,0,'theme_default','theme_default_image_product_width','228',0),(141,0,'theme_default','theme_default_image_product_height','228',0),(142,0,'theme_default','theme_default_image_additional_width','74',0),(143,0,'theme_default','theme_default_image_additional_height','74',0),(144,0,'theme_default','theme_default_image_related_width','200',0),(145,0,'theme_default','theme_default_image_related_height','200',0),(146,0,'theme_default','theme_default_image_compare_width','90',0),(147,0,'theme_default','theme_default_image_compare_height','90',0),(148,0,'theme_default','theme_default_image_wishlist_width','47',0),(149,0,'theme_default','theme_default_image_wishlist_height','47',0),(150,0,'theme_default','theme_default_image_cart_height','47',0),(151,0,'theme_default','theme_default_image_cart_width','47',0),(152,0,'theme_default','theme_default_image_location_height','50',0),(153,0,'theme_default','theme_default_image_location_width','268',0),(154,0,'theme_default','theme_default_directory','default',0),(155,0,'theme_default','theme_default_status','1',0),(156,0,'dashboard_activity','dashboard_activity_status','1',0),(157,0,'dashboard_activity','dashboard_activity_sort_order','7',0),(158,0,'dashboard_sale','dashboard_sale_status','1',0),(159,0,'dashboard_sale','dashboard_sale_width','3',0),(160,0,'dashboard_chart','dashboard_chart_status','1',0),(161,0,'dashboard_chart','dashboard_chart_width','6',0),(162,0,'dashboard_customer','dashboard_customer_status','1',0),(163,0,'dashboard_customer','dashboard_customer_width','3',0),(164,0,'dashboard_map','dashboard_map_status','1',0),(165,0,'dashboard_map','dashboard_map_width','6',0),(166,0,'dashboard_online','dashboard_online_status','1',0),(167,0,'dashboard_online','dashboard_online_width','3',0),(168,0,'dashboard_order','dashboard_order_sort_order','1',0),(169,0,'dashboard_order','dashboard_order_status','1',0),(170,0,'dashboard_order','dashboard_order_width','3',0),(171,0,'dashboard_sale','dashboard_sale_sort_order','2',0),(172,0,'dashboard_customer','dashboard_customer_sort_order','3',0),(173,0,'dashboard_online','dashboard_online_sort_order','4',0),(174,0,'dashboard_map','dashboard_map_sort_order','5',0),(175,0,'dashboard_chart','dashboard_chart_sort_order','6',0),(176,0,'dashboard_recent','dashboard_recent_status','1',0),(177,0,'dashboard_recent','dashboard_recent_sort_order','8',0),(178,0,'dashboard_activity','dashboard_activity_width','4',0),(179,0,'dashboard_recent','dashboard_recent_width','8',0),(187,0,'config','config_langdata','{\"1\":{\"meta_title\":\"\\u041c\\u043e\\u0439 \\u041c\\u0430\\u0433\\u0430\\u0437\\u0438\\u043d\",\"meta_description\":\"\\u041c\\u043e\\u0439 \\u041c\\u0430\\u0433\\u0430\\u0437\\u0438\\u043d\",\"meta_keyword\":\"\",\"name\":\"\\u041c\\u043e\\u0439 \\u041c\\u0430\\u0433\\u0430\\u0437\\u0438\\u043d\",\"owner\":\"\\u041c\\u043e\\u0435 \\u0418\\u043c\\u044f\",\"address\":\"\\u0410\\u0434\\u0440\\u0435\\u0441\",\"open\":\"\\u0441 10\\u0447 \\u0434\\u043e 18\\u0447\\r\\n\\u043e\\u0431\\u0435\\u0434 \\u0441 14\\u0447 \\u0434\\u043e 15\\u0447\\r\\n\\u0432\\u043e\\u0441\\u043a\\u0440\\u0435\\u0441\\u0435\\u043d\\u044c\\u0435 - \\u0432\\u044b\\u0445\\u043e\\u0434\\u043d\\u043e\\u0439\",\"comment\":\"\"},\"2\":{\"meta_title\":\"Your Store\",\"meta_description\":\"My Store\",\"meta_keyword\":\"\",\"name\":\"Your Store\",\"owner\":\"Your Name\",\"address\":\"Address 1\",\"open\":\"\",\"comment\":\"\"}}',1),(196,0,'config','config_zone_id','2785',0),(197,0,'config','config_language','ru-ru',0),(198,0,'config','config_admin_language','ru-ru',0),(199,0,'config','config_currency','RUB',0),(200,0,'config','config_currency_engine','cbr',0),(201,0,'config','config_currency_auto','1',0),(202,0,'config','config_length_class_id','1',0),(203,0,'config','config_weight_class_id','1',0),(204,0,'config','config_product_count','0',0),(205,0,'config','config_limit_admin','20',0),(206,0,'config','config_limit_autocomplete','5',0),(207,0,'config','config_product_upc_hide','0',0),(208,0,'config','config_product_ean_hide','0',0),(209,0,'config','config_product_jan_hide','0',0),(210,0,'config','config_product_isbn_hide','0',0),(211,0,'config','config_product_mpn_hide','0',0),(212,0,'config','config_review_status','1',0),(213,0,'config','config_review_guest','1',0),(186,0,'filter','filter_status','1',0),(278,0,'config','config_secure','0',0),(279,0,'config','config_password','1',0),(280,0,'config','config_shared','0',0),(281,0,'config','config_encryption','',0),(282,0,'config','config_file_max_size','300000',0),(283,0,'config','config_file_ext_allowed','zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc',0),(284,0,'config','config_file_mime_allowed','text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf',0),(285,0,'config','config_error_display','1',0),(286,0,'config','config_error_log','1',0),(287,0,'config','config_error_filename','error.log',0),(288,0,'config','config_sms_alert','0',0),(289,0,'config','config_sms_gatename','smsc',0),(290,0,'config','config_sms_from','',0),(291,0,'config','config_sms_to','',0),(292,0,'config','config_sms_copy','',0),(293,0,'config','config_sms_message','',0),(294,0,'config','config_sms_gate_username','',0),(295,0,'config','config_sms_gate_password','',0),(296,0,'config','config_meta_title','Мой Магазин',0),(297,0,'config','config_meta_description','Мой Магазин',0),(298,0,'config','config_meta_keyword','',0),(299,0,'config','config_name','Мой Магазин',0),(300,0,'config','config_owner','Мое Имя',0),(301,0,'config','config_address','',0);
...
INSERT INTO `oc_user` VALUES (1,1,'admin','6c55659f39492f0826a48945276eaa5d35969373','MVb7rb7fH','John','Doe','sample@yandex.ru','','','89.109.32.149',1,'2023-03-05 15:17:20');
...
-- Dump completed on 2023-03-06 21:32:13
